...
1. Open `assets/js/config.js` and replace the shared contact information, links, current weight, and last-updated date.
...
- `engineering.html` - technical design documentation

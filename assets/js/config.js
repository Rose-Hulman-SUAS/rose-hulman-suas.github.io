/*
  ...
  These values are reused across the website so you only need to update them once.
*/
window.RAS_CONFIG = {
  season: "2025-2026",
  competitionName: "Student Unmanned Aerial Systems Competition",
  aircraftName: "MeadowHawk",
